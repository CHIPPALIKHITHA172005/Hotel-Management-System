...
public class AddRooms extends JFrame implements ActionListener{
    ...
    AddRooms(){
        ...
        heading.setBounds(115,20,200,20);
        add(heading);
        ...
        JLabel lblavaliable = new JLabel("Avaliable");
        lblavaliable.setFont(new Font("Tahoma",Font.BOLD, 15));
        lblavaliable.setBounds(60, 135, 120, 20);
        add(lblavaliable);
        ...
        image.setBounds(400, 10, 500, 300);
        add (image);
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == add){
            ...
            try{
                ...
                JOptionPane.showMessageDialog(null, "Room Successfully Added successfully");
